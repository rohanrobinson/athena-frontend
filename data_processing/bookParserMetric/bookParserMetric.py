# Adapted from The HuggingFace Datasets Authors and the current dataset script contributor.

"""BookParserMetric F1 metric. + Accuracy"""
...
Returns:
    ...
    Accuracy: Accuracy
Examples:
    >>> bookParser_metric = datasets.load_metric("bookParserMetric")
    >>> results = bookParser_metric.compute(references=[0, 1], predictions=[0, 1])
    >>> print(results)
    {'accuracy: .8', f1': 1.0}
"""
